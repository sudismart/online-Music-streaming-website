             ...
             <nav id="myNavbar" class="navbar navbar-default navbar-fixed-top" role="navigation">        
                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a href="bolly.php" class="navbar-brand" style="color:#33ADD6">BOLLYWOOD 360</a>
                    </div>
...
<br/>
        ...
        <section id="contact" class="container content-section text-center">
         ...
         <!--   audio player   -->
      <nav  id="#audio_player" class="navbar navbar-custom navbar-fixed-bottom" role="navigation" style="background-color: rgba(49, 168, 241, 0.9); height:100px">
        <div class="container-fluid" style="padding:0px;border:0px ">
          <div class="row">
                <div id="poster_img" class="col-md-1" >
                    <img  id="poster" style="width:100px; top:3px" />
                </div>
                ...
                <div class="col-md-9" style="background:grey; height:75px">
                    <div id="indication" style="top:30px;width:1000px;height:75px;padding-top:25px">
                        ...
                        <div id="current_time" style="width:60px;padding-left:10px;float:left" >00:00</div>
                        ...
                        <div id="#connect" style="padding-left:15px ;float:left;width:170px">
